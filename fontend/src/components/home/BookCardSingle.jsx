...
function BookCardSingle({ book }) {
    ...
    return (
        <div key={book._id}
            className='border-2 border-gray-500 rounded-lg relative px-4 py-2 m-4 hover:shadow-xl'>
            ...
            <div className='flex justify-between items-center gap-x-2 mt-4 p-4'>
                <BiShow className='text-3xl text-blue-700 hover:text-black cursor-pointer'
